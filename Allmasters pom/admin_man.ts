...
export default class{
      ...
      async filter_Europe(){
       ...
       async active(){
        await this.page.locator("//button[@value='1']").click()
       }
       async Inactive(){
        await this.page.locator("//button[@value='2']").click()
       }
       async pop_up_yes(){
...
//cargo details page validation in both
   ...
   // my account page
     async ff_name(){
       await this.page.locator("//a[@role='button']").click()
     }
     async my_account(){
...
//await this.page.locator("//input[@id='Invoice']").setInputFiles("data-files/Gst.pdf")
     ...
     //input[@placeholder='Search Forwarders']
